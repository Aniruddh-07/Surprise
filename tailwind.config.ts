    ...
    extend: {
      colors: {
        ...
        valentine: {
          ...
          "warm-white": "hsl(var(--valentine-warm-white))",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(340 82% 76% / 0.3)" },
          "50%": { boxShadow: "0 0 40px hsl(340 82% 76% / 0.6)" },
        },
        "fade-in-up": {
        ...
        "blink": {
          ...
          "51%, 100%": { borderColor: "hsl(340 65% 55%)" },
        },
        "confetti-fall": {
